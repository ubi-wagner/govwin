# Delivery management — CLIN · WBS · deliverables

**Status:** design, not built. Decisions locked with the operator 2026-08-26.
...
cells are bound to `delivery_wbs_nodes` rows rather than to a document blob.
...
CREATE TABLE delivery_source_documents (
  id              uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id       uuid NOT NULL REFERENCES tenants(id),
...
CREATE TABLE delivery_wbs_nodes (
  id              uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id       uuid NOT NULL REFERENCES tenants(id),
  project_id      uuid NOT NULL REFERENCES delivery_projects(id) ON DELETE CASCADE,
...
CREATE TABLE delivery_provenance (
  id              uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id       uuid NOT NULL REFERENCES tenants(id),
  target_table    text NOT NULL,    -- 'delivery_clins' | 'delivery_milestones' | …
  target_id       uuid NOT NULL,
  field           text NOT NULL,    -- 'pop_end', 'funded_amount', …
  method          text NOT NULL,    -- hitl | verified | override | pattern_match | ai | default
  source_doc_id   uuid REFERENCES delivery_source_documents(id),
  page            integer,
  excerpt         text,
  char_offset     integer,
  created_at      timestamptz NOT NULL DEFAULT now()

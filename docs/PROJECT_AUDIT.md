...
> **⚠️ FROZEN at migration head 141 (historical snapshot).** The tree is now at **head 185** — every count
> below (142 migration files · 105 tables · 191 routes · 104 pages · 36 archetypes · 172 lib modules) is
> as-of-141 and NOT current. For the current state see **ARCHITECTURE_V10.md**, **docs/LAUNCH_STATUS.md**,
> **CLAUDE_CLIFFNOTES.md** (schema), and **docs/LAUNCH_READINESS_2026-08.md**. Retained for its methodology
> + point-in-time dead-code / bug findings; a fresh re-run at head 185 is tracked as a fast-follow.

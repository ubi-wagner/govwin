...
sec(id="workspace", toc="4 · The workspace", heading="Inside the proposal — your view",
    ...
    callouts=[{"kind":"note","html":"If the agency <b>amends</b> the solicitation, an amber banner appears at the top of the "
      "workspace with the change. You can read it (and expand the compliance delta), but <b>only a company admin can "
      "acknowledge</b> it — “An admin must acknowledge these changes.” Re-check any section you’re drafting against the change."}])

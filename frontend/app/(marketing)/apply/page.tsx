        ...
        <div className="max-w-4xl mx-auto px-6 py-20 md:py-28">
          ...
          <div className="mt-6 p-4 bg-navy-800/50 border border-navy-600 rounded-lg">
            <p className="text-sm text-gray-300">
              {(hero?.metadata as { before_you_apply?: string })?.before_you_apply ?? <><strong className="text-white">Before you apply:</strong> This is a paid service ($299/month after acceptance). There is no free trial. If accepted, you&rsquo;ll be invited to onboard, register your admin, upload foundational company documents, and activate your subscription via Stripe.</>}
            </p>
          </div>
        </div>
      </section>

...
export function CheckoutButton({ plans }: { plans: Plan[] }) {
  ...
  return (
    <>
      {/* Billing toggle — rendered outside the modal so the page can use it */}
      ...
      {/* Hidden state provider for pricing cards — pass billing period via data attribute */}
...
/** Client wrapper for a pricing card that opens the checkout modal */

    ...
    <div className="min-h-screen flex">
      <aside className="w-64 bg-navy-900 text-white p-6 flex flex-col">
        ...
        <nav className="flex flex-col gap-1 text-sm flex-1">
          ...
          <a href="/admin/process" className="px-2 py-1.5 rounded hover:bg-navy-800 hover:text-brand-300">Process Monitor</a>
          ...
          <a href="/admin/documents" className="px-2 py-1.5 rounded hover:bg-navy-800 hover:text-brand-300">Document Builder</a>

...
export default function IntakeForm() {
  const [f, setF] = useState({ title: '', agency: '', office: '', solicitationNumber: '', programType: 'SBIR', closeDate: '', poc: '', pocEmail: '', sourceUrl: '', description: '', docsDownloadable: false });
  ...
  const submit = async () => {
    ...
    try {
      ...
      if (res.ok) setF({ title: '', agency: '', office: '', solicitationNumber: '', programType: 'SBIR', closeDate: '', poc: '', pocEmail: '', sourceUrl: '', description: '', docsDownloadable: false });

...
const ROSTER: Agent[] = [
  ...
  { role: 'research_scout', label: 'Research Scout', scope: 'tenant', trigger: 'Research requested (proposal R&D)', status: 'wired', pod: 'Tenant — build & pursue', does: 'Finds cited market research / prior art via the controlled browser; web results injection-fenced, budget-capped, human-gated.' },
  // ── Master — ingestion (platform) ────────────────────────────────────────

...
type Tab = 'library' | 'package' | 'atomize';
const LABELS: Record<Tab, string> = { library: 'Library', package: 'Upload package', atomize: 'Atomize' };

/** Tabbed home for the atom library: browse · bulk-atomize a package · hand-shred. */
  ...
  return (
    <div className="space-y-4">
      <div className="flex gap-1 border-b border-gray-200 text-sm">
        {(['library', 'package', 'atomize'] as const).map((t) => (

...
import { LibraryReview } from './library-review';

type Tab = 'library' | 'review' | 'package' | 'atomize' | 'capture';
const LABELS: Record<Tab, string> = { library: 'Library', review: 'Review', package: 'Upload package', atomize: 'Atomize', capture: 'Capture' };
const TABS: readonly Tab[] = ['library', 'review', 'package', 'atomize', 'capture'];

...
function CanvasEditorInner({
  ...
  // canvas — off by default. (Section boundaries only exist in the assembled fluid view, so the
  // Sections chip is omitted here.) Slides render through the same CanvasRenderer, so they inherit.

...
// ═══════════════════════════════════════════════════════════════════════════
const tv = doc(letter('Technical Volume', 'Navy STTR Phase I · Topic N25B-T042 · Proprietary', 11.5, 1.5, 12), [
...
// ═══════════════════════════════════════════════════════════════════════════
const sow = doc(letter('Statement of Work', 'Navy STTR Phase I · Topic N25B-T042 · Proprietary', 11, 1.4, 8), [
  ...
  h(2, 'Base Period Tasks (Months 1–18)', '#0e7490'),
  ...
  brk(),
  h(2, 'Option Period Tasks (Months 19–24, if exercised)', '#0e7490'),
  table(['Task', 'Title', 'Lead', 'Months', 'Deliverable'], [
  ...
  brk(),
  h(2, 'Deliverables and Schedule', '#0e7490'),
...
const overview = doc(slide, [
  ...
  brk(),
  // 9 — Transition & Commercialization

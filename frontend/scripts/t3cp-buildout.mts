 ...
 *
 *  cd frontend && node --import tsx scripts/t3cp-buildout.mts */
...
const TECH = 10; // page_limit_technical — Technical Volume NTE 10 pages
...
const PLAN: Record<number, Item[]> = {
  ...
  2: [
    { itemName: 'Identification and Significance of the Problem or Opportunity (with T3CP sector area)', itemType: 'text', pageLimit: TECH,
    ...
    { itemName: 'Patent Identification — DoW Patent Number(s) and Associated Laboratory', itemType: 'text', pageLimit: TECH,
    ...
    { itemName: 'Commercial Evaluation License (CEL) Status or Plan to Obtain', itemType: 'text', pageLimit: TECH,
    ...
    { itemName: 'Proposed Product or Prototype Concept and Intended Commercial and/or Defense End Use', itemType: 'text', pageLimit: TECH },
    { itemName: 'Technical Modifications Required to Adapt the Patented Invention', itemType: 'text', pageLimit: TECH,
      expertNotes: 'Evolutionary-only improvements to the existing state of practice are excluded from award.' },
    { itemName: 'Phase I Technical Objectives', itemType: 'text', pageLimit: TECH },
    { itemName: 'Phase I Statement of Work', itemType: 'text', pageLimit: TECH,
    ...
    { itemName: 'Anticipated Performance Improvements, Commercial Value, and Transition Approach', itemType: 'text', pageLimit: TECH },
    { itemName: 'Logistics, Safety, and Regulatory Considerations', itemType: 'text', pageLimit: TECH },
    { itemName: 'Related Work, Key Personnel, Facilities/Equipment, and Subcontractors/Consultants', itemType: 'text', pageLimit: TECH },
  ],

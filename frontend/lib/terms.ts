export const TERMS_VERSION = 'v2-founding-cohort';
...
RFP Pipeline ("the Platform") is a data processing, AI-acceleration, and expert-curated opportunity management service for small businesses pursuing federal research and development funding. The Platform provides AI-assisted proposal drafting, compliance matrix curation, opportunity matching, and document management tools.
...
As the designated administrator, you are solely responsible for:
(a) All users, employees, and collaborators you invite to or grant access to your company workspace;
(b) The accuracy, legality, and appropriateness of all content uploaded to the Platform;
(c) Ensuring that any team members or partners you add comply with these terms;
(d) Managing access permissions and revoking access when appropriate;
...
(c) RFP Pipeline does not guarantee the accuracy, completeness, or timeliness of opportunity data sourced from federal databases (SAM.gov, SBIR.gov, Grants.gov, etc.).
(d) You are solely responsible for reviewing and verifying all materials before submission to any federal agency.
(e) RFP Pipeline is not a legal, financial, or government contracting advisory service. Consult qualified professionals for such advice.

6. LIMITATION OF LIABILITY
TO THE MAXIMUM EXTENT PERMITTED BY LAW, RFP PIPELINE SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO LOSS OF PROFITS, DATA, BUSINESS OPPORTUNITIES, OR GOODWILL, ARISING OUT OF OR RELATED TO YOUR USE OF THE PLATFORM, REGARDLESS OF WHETHER SUCH DAMAGES WERE FORESEEABLE OR WHETHER RFP PIPELINE WAS ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. RFP PIPELINE'S TOTAL AGGREGATE LIABILITY SHALL NOT EXCEED THE AMOUNTS YOU PAID TO RFP PIPELINE IN THE TWELVE (12) MONTHS PRECEDING THE CLAIM.
...
(c) You acknowledge this risk and agree that RFP Pipeline's liability for data security incidents is limited as set forth in Section 6.
...
(e) RFP Pipeline reserves the right to terminate your account for violation of these terms, with 30 days' notice except in cases of egregious violations.
...
(b) De-identified, aggregated insights derived from platform usage may be used to improve the service for all customers. No individual customer data will be shared or identifiable.

11. INDEMNIFICATION
You agree to indemnify, defend, and hold harmless RFP Pipeline, its officers, directors, employees, and agents from any claims, damages, losses, or expenses (including reasonable attorneys' fees) arising from: (a) your use of the Platform, (b) your violation of these terms, (c) your violation of any applicable law, or (d) any content you upload to the Platform.

12. GOVERNING LAW AND DISPUTE RESOLUTION
These terms shall be governed by the laws of the State of Ohio. Any disputes shall be resolved through binding arbitration in accordance with the rules of the American Arbitration Association, conducted in Ohio. Each party bears its own attorneys' fees.

13. MODIFICATIONS
RFP Pipeline may modify these terms at any time. Material changes will be communicated via email at least 30 days before taking effect. Continued use of the Platform after the effective date constitutes acceptance.

14. ENTIRE AGREEMENT
These Terms & Conditions constitute the entire agreement between you and RFP Pipeline regarding use of the Platform and supersede any prior agreements or understandings.`;

...
export const value: SeedPage = {
  ...
  blocks: [
    ...
    { section: 'comparison-row', displayOrder: 0, title: 'Active opportunity monitoring', excerpt: '$5,000 / mo', body: 'Expert-curated monitoring for ~6% of the price — a human reads every solicitation, not just a keyword feed.', metadata: { statusQuoNote: 'what our founder paid for a monitoring service', ours: '$299 / mo' } },
    { section: 'comparison-row', displayOrder: 1, title: 'A proposal consultant', excerpt: '10% of award', body: 'Keep the $100K. Pay for the build, never a cut of your win.', metadata: { statusQuoNote: 'a $1M Phase II ⇒ $100,000 — or a heavy monthly retainer', ours: '$999 / $1,999 flat' } },

...
export const value: SeedPage = {
  ...
  blocks: [
    ...
    { section: 'comparison-row', displayOrder: 0, title: 'Active opportunity monitoring', excerpt: '$5,000 / mo', body: 'Expert-curated monitoring for about 6% of the price — a human reads every solicitation, not just a keyword feed.', metadata: { statusQuoNote: 'what our founder paid for a monitoring service', ours: '$499 / mo' } },

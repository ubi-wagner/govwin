...
export const resources: SeedPage = {
  ...
  blocks: [
    ...
    { section: 'programs', displayOrder: 2, title: 'SBIR', body: 'Small Business Innovation Research — Phase I through Phase III across all DoD branches, NSF, DOE, NIH, and more.', metadata: {} },
    { section: 'programs', displayOrder: 3, title: 'STTR', body: 'Small Business Technology Transfer — requires a research institution partner. Same agencies, different collaboration model.', metadata: {} },
    { section: 'programs', displayOrder: 4, title: 'BAA', body: 'Broad Agency Announcements — open-ended R&D solicitations from DARPA, AFRL, Army Research Lab, and others.', metadata: {} },
    { section: 'programs', displayOrder: 5, title: 'OTA', body: 'Other Transaction Authority — non-FAR contracting for prototype development. Faster timelines, different compliance.', metadata: {} },
    { section: 'programs', displayOrder: 6, title: 'CSO', body: 'Commercial Solutions Openings — typically Air Force (AFWERX). Slide-deck format, short-form proposals.', metadata: {} },
    { section: 'programs', displayOrder: 7, title: 'Grants / NOFO', body: 'Grants.gov Notices of Funding Opportunity — NSF, DOE, NIH. CFDA-based, different compliance structure.', metadata: {} },

...
export const PAGE_DEFAULTS: Record<string, { content: Record<string, unknown>; metadata: { title: string; description: string } }> = {
  about: {
    ...
    metadata: {
      title: 'About GovWin | SBIR/STTR Opportunity Intelligence',
      description: 'Learn how GovWin helps small businesses discover, score, and win SBIR/STTR awards and federal research funding using AI-powered opportunity matching.',
    },
  },
  ...
  team: {
    ...
    metadata: {
      title: 'Our Team | GovWin',
      description: 'Meet the team behind GovWin — decades of experience winning SBIR/STTR awards, technology commercialization, and startup support.',
    },
  },
  ...
  customers: {
    ...
    metadata: {
      title: 'Customer Wins | GovWin',
      description: 'See how companies are using GovWin to discover and win SBIR/STTR awards and federal research funding.',
    },
  },
  ...
  announcements: {
    ...
    metadata: {
      ...
      description: 'Latest news, product updates, and announcements from GovWin.',
    },
  },
  ...
  get_started: {
    ...
    metadata: {
      title: 'Get Started | GovWin',
      description: 'Start finding and winning SBIR/STTR opportunities today. $199/mo for AI-powered intelligence plus per-proposal expert support.',
    },
  },
  ...
  home: {
    ...
    metadata: {
      title: 'GovWin | SBIR/STTR Opportunity Intelligence',
      description: 'Find, score, and win SBIR/STTR awards with AI-powered opportunity matching. Built for small businesses pursuing federal research funding.',
    },
  },
}

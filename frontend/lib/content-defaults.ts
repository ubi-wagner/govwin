...
export const PAGE_DEFAULTS: Record<string, { content: Record<string, unknown>; metadata: { title: string; description: string } }> = {
  ...
  get_started: {
    content: {
      ...
      tiers: [
        { name: 'Starter', price: '$49/mo', description: 'Perfect for small businesses exploring federal contracting.', features: ['Up to 50 scored opportunities/month', '1 user workspace', '3 NAICS code profiles', 'Weekly email digest', 'SAM.gov opportunity scanning', 'Basic deadline alerts'] },
        { name: 'Professional', price: '$149/mo', description: 'For active bidders who need a competitive edge.', features: ['Unlimited scored opportunities', 'Up to 5 user workspaces', 'Unlimited NAICS code profiles', 'Daily email digest + real-time alerts', 'AI-powered scoring & ranking', 'Set-aside matching', 'Document management', 'Priority support'] },
        { name: 'Enterprise', price: '$399/mo', description: 'For teams and accelerators managing multiple pipelines.', features: ['Everything in Professional', 'Unlimited user workspaces', 'Multi-tenant management', 'Batch onboarding (accelerator cohorts)', 'Custom scoring profiles', 'API access', 'Dedicated account manager', 'SSO & advanced security'] },
      ],
      faqs: [
        { question: 'How does the free trial work?', answer: 'You get 14 days of full access to your selected plan. No credit card required to start.' },
        { question: 'Can I change plans later?', answer: 'Absolutely. Upgrade or downgrade at any time. Changes take effect at your next billing cycle.' },
        { question: 'Do you offer annual billing?', answer: 'Yes — annual plans save you 20%. Contact us for a custom annual agreement.' },
        { question: 'Is there a setup fee?', answer: 'No setup fees, ever. Your workspace is provisioned instantly when you subscribe.' },
      ],
    },
    metadata: {

        ...
        while not shutdown_event.is_set():
            try:
                ...
                for event_row in events:
                    ...
                    if workflow_cls:
                    ...
                    elif fabric is not None and fabric.has_handler(event_dict["type"]):
                        ...
                        # color_team_reviewer. invoke_agent enforces per-tenant rate +
                        # monthly budget, so this is bounded; handle_event returns a status
                        # dict (never raises), but guard defensively anyway.
                        try:
